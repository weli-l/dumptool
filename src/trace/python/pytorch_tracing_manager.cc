...
void PyTorchTracingManager::initSingleton() { instance_ = new PyTorchTracingManager(); }

PyTorchTracingDataArray* PyTorchTracingManager::getEmptyPyTorchTracingDataArray(
    int name) {
...
PyTorchTracingDataArray* PyTorchTracingManager::getPyTorchTracingDataArray(int name) {
  auto& item = pool_[name];
