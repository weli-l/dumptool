...
PyTorchTracingLibrary::PyTorchTracingLibrary(const std::string& library_path)
  ...
  SETUP_SYMBOL_FOR_LOAD_LIBRARY(handle_, "systrace_register_tracing",
                                register_tracing_, SysTraceRegisterTracingFunc,
                                err);
  SETUP_SYMBOL_FOR_LOAD_LIBRARY(
      handle_, "systrace_get_full_pytorch_tracing_data_array", get_tracing_data_,
      GetFullTracingDataArrayFunc, err);
  SETUP_SYMBOL_FOR_LOAD_LIBRARY(
      handle_, "systrace_return_pytorch_tracing_data_array", return_tracing_data_,
...
std::vector<std::string> PyTorchTracingLibrary::Register(
